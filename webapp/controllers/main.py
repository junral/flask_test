...
from flask_prinicipal import Identity, AnonymousIdentity, identity_changed

from ..models import User
from ..forms import LoginForm, RegisterForm, OpenIDForm
from ..extensions import oid, facebook, twitter
...
def login():
    ...
    if openid_form.openid.validate_on_submit():
